...
class ControllerPaymentPaysondirect extends Controller {
    ...
    public function index() {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/payment/paysondirect.tpl')) {
            return $this->load->view($this->config->get('config_template') . '/payment/paysondirect.tpl', $this->data);
        } else {
            $this->template = 'payment/paysondirect.tpl';
            return $this->load->view('payment/paysondirect.tpl', $this->data);
        }
    }
